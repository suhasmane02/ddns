...
public class XMLTreee extends JTree {
  public XMLTreee(String filename) throws IOException {
    this(filename, new FileInputStream(new File(filename)));
  }

  public XMLTreee(String filename, InputStream in) {
 ...
 private static String treeNodeLabel(Node childElement) {
    ...
    if(childElement instanceof Element)
    {
        ...
        treeNodeLabel = e.getAttribute("name");  //childElement.getNodeName();
    }
