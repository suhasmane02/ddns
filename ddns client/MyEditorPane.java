...
/**
 * Own EditorPane extended from JEditorPane used for customization (to add qwn functionality).
 *
 * @author anonymous_02
 */
public class MyEditorPane extends JEditorPane {
    ...
    /**
     * Creates a new <code>MyEditorPane</code>.
    ...
    /**
     * Creates a <code>MyEditorPane</code> based on a specified URL for input.
     *
    ...
    /**
     * Creates a <code>MyEditorPane</code> based on a string containing
     * a URL specification.
     *
     * @param url the URL
    ...
    /**
     * Creates a <code>MyEditorPane</code> that has been initialized
...
//        if ((loaded == null) || !loaded.sameFile(page) || (postData != null)) 
        ...
        public void run() {
            try {
                if (in == null) {
                    ...
                    synchronized (MyEditorPane.this) {
                ...
                UIManager.getLookAndFeel().provideErrorFeedback(MyEditorPane.this);
            } finally {
                synchronized (MyEditorPane.this) {
                    loading = null;
                }
    ...
    private static Hashtable getKitTypeRegistry() {
        ...
        return (Hashtable) appContextGet(kitTypeRegistryKey);
    }

    private static Hashtable getKitLoaderRegistry() {
        loadDefaultKitsIfNecessary();
        return (Hashtable) appContextGet(kitLoaderRegistryKey);
    }

    private static Hashtable getKitRegisty() {
        Hashtable ht = (Hashtable) appContextGet(kitRegistryKey);
        if (ht == null) {
            ht = new Hashtable(3);
            appContextPut(kitRegistryKey, ht);
        }
        return ht;
    }

    private static void loadDefaultKitsIfNecessary() {
        if (appContextGet(kitTypeRegistryKey) == null) {
            ...
            appContextPut(kitTypeRegistryKey, ht);
            ht = new Hashtable();
            appContextPut(kitLoaderRegistryKey, ht);
    ...
    static void setWriteObjCounter(MyEditorPane comp, byte count) {
        comp.flags = (comp.flags & ~(0xFF << WRITE_OBJ_COUNTER_FIRST)) |
                (count << WRITE_OBJ_COUNTER_FIRST);
    }

    static byte getWriteObjCounter(MyEditorPane comp) {
    ...
    protected class AccessibleJEditorPane extends AccessibleJTextComponent {
        ...
        public String getAccessibleDescription() {
            ...
            if (description == null) {
                description = MyEditorPane.this.getContentType();
            }
            return description;
        }
    ...
    protected class AccessibleJEditorPaneHTML extends AccessibleJEditorPane {
        ...
        protected AccessibleJEditorPaneHTML() {
            HTMLEditorKit kit = (HTMLEditorKit) MyEditorPane.this.getEditorKit();
    ...
    protected class JEditorPaneAccessibleHypertextSupport
        ...
        public class HTMLLink extends AccessibleHyperlink {
                ...
                if (i == 0 && isValid() == true) {
                    ...
                    if (u != null) {
                        HyperlinkEvent linkEvent =
                                new HyperlinkEvent(MyEditorPane.this, HyperlinkEvent.EventType.ACTIVATED, u);
                        MyEditorPane.this.fireHyperlinkUpdate(linkEvent);
                        return true;
                    }
                }
                return false;
            ...
            public String getAccessibleActionDescription(int i) {
                if (i == 0 && isValid() == true) {
                    Document d = MyEditorPane.this.getDocument();
                    if (d != null) {
                        try {
            ...
            public Object getAccessibleActionObject(int i) {
                if (i == 0 && isValid() == true) {
                    ...
                    if (href != null) {
                        URL u;
                        try {
                            u = new URL(MyEditorPane.this.getPage(), href);
        ...
        public int getLinkIndex(int charIndex) {
            ...
            Element e = null;
            Document doc = MyEditorPane.this.getDocument();
            if (doc != null) {
